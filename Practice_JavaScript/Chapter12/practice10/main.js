...
const fruits = ['apple','grape', 'banana', 'orange', 'peach'];

each(fruits, (fruit, index) => {
    console.log('番号' + index + ' : ' + fruit);
});
...
const firlteredNumbers = filter(numbers, (num, i) => {
    return num % 2 === 1;
});

console.log('firlteredNumbers? : ', firlteredNumbers);